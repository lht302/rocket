...
class DCacheModule(outer: DCache) extends HellaCacheModule(outer) {
  ...
  //======lht:start========
// dontTouch(doUncachedResp)
// dontTouch(s2_data_error)
// dontTouch(s2_valid_hit_pre_data_ecc)
// dontTouch(s2_waw_hazard)
// dontTouch(s2_store_merge)
// dontTouch(s2_no_alloc_hazard)
// dontTouch(s2_meta_error) 
// dontTouch(s2_hit)
// dontTouch(s2_hit_state)
// dontTouch(s1_hit_state)
